...
class UsersService {
   ...
   */ async getAllUsers(params) {
        try {
            ...
            console.log('[Users Service] POST Body:', JSON.stringify(tRPCBody, null, 2));
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post('/api/trpc/admin.users.getAll', tRPCBody);
   ...
   */ async getUserById(userId) {
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].get(`/api/trpc/admin.users.getById?input=${encodeURIComponent(JSON.stringify({
                id: userId
            }))}`);
            if (response.success && response.data) {
                return {
...
"[project]/components/pages/users-list.tsx [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/components/pages/users-list.tsx'\n\nUnexpected token. Did you mean `{'}'}` or `&rbrace;`?");
...
//# sourceMappingURL=_8103c86a._.js.map