module.exports = [
"[project]/lib/api/merchandise.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class MerchandiseService {
   ...
   */ async getAllProducts(params) {
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post('/api/trpc/admin.merchandise.getAll', tRPCBody);
   ...
   */ async getProductById(productId) {
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post(`/api/trpc/admin.merchandise.getById`, tRPCBody);
            if (response.success && response.data) {
                return {
                    success: true,
                    data: response.data
   ...
   */ async createProduct(data) {
        try {
            ...
            const baseURL = ("TURBOPACK compile-time value", "https://mjzctqcx-3000.asse.devtunnels.ms/") || 'https://mjzctqcx-3000.asse.devtunnels.ms';
   ...
   */ async deleteProduct(productId) {
        try {
            const baseURL = ("TURBOPACK compile-time value", "https://mjzctqcx-3000.asse.devtunnels.ms/") || 'https://mjzctqcx-3000.asse.devtunnels.ms';
            const token = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : null;
            const response = await fetch(`${baseURL}/api/admin/products/delete`, {
                method: 'POST',
                headers: {
...
"[project]/components/pages/merchandise-list.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$merchandise$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api/merchandise.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function MerchandiseList() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchProducts = async ()=>{
            ...
            setError(null);
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$merchandise$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["merchandiseService"].getAllProducts({
                    page: currentPage,
                    limit: 20,
    ...
    const confirmDelete = async ()=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$merchandise$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["merchandiseService"].deleteProduct(deletingProduct.id);
            if (response.success) {
                setDeletingProduct(null);
                // Refresh products list
                const refreshResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$merchandise$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["merchandiseService"].getAllProducts({
                    page: currentPage,
                    limit: 20,
                    search: searchTerm || undefined
                });
    ...
    const saveProduct = async ()=>{
        ...
        try {
            ...
            if (editingProduct) {
                // Update product
                response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$merchandise$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["merchandiseService"].updateProduct({
                    ...productData,
                    id: editingProduct.id
                });
            } else {
                // Create product
                response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$merchandise$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["merchandiseService"].createProduct(productData);
            }
            if (response.success) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                    ...
                                                    className: "flex-1 px-4 py-2.5 bg-muted/50 border border-border rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition-all"
                                                }, void 0, false, {
                                                    fileName: "[project]/components/pages/merchandise-list.tsx",
                                                    lineNumber: 457,
                                                    columnNumber: 19
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    type: "button",
                                                    onClick: addSize,
                                                    className: "px-4 py-2.5 bg-accent/10 text-accent rounded-lg hover:bg-accent/20 transition-colors font-medium",
                                                    children: "Add"
                                                }, void 0, false, {
                                                    fileName: "[project]/components/pages/merchandise-list.tsx",
                                                    lineNumber: 470,
                                        ...
                                        sizes.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: sizes.map((size)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        editingProduct && editingProduct.image && selectedImages.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "mt-2",
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            ...
            deletingProduct && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_96d4f164._.js.map