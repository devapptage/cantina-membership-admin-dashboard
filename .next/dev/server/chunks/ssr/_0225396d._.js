...
const products = [
    {
        id: 1,
        name: "Anejo Premium T-Shirt",
        description: "Premium cotton t-shirt with Anejo logo",
        category: "Apparel",
        price: "$29.99",
        stock: 25,
        available: true
    ...
    {
        id: 2,
        name: "Mezcal Tasting Glass Set",
        description: "Set of 4 professional tasting glasses",
        category: "Glassware",
        price: "$49.99",
        stock: 12,
        available: true
    ...
    {
        id: 4,
        name: "Branded Shot Glasses",
        description: "Set of 6 branded shot glasses",
        category: "Glassware",
        price: "$34.99",
        stock: 18,
        available: true
    },
    {
        id: 5,
        name: "Cantina Hoodie",
        description: "Comfortable zip-up hoodie with logo",
        category: "Apparel",
        price: "$59.99",
        stock: 8,
        available: true
...
function MerchandiseList() {
    ...
    const filteredProducts = products.filter((product)=>product.name.toLowerCase().includes(searchTerm.toLowerCase()) || product.description.toLowerCase().includes(searchTerm.toLowerCase()) || product.category.toLowerCase().includes(searchTerm.toLowerCase()));
    ...
    const totalValue = products.reduce((sum, p)=>{
        const priceNum = Number.parseFloat(p.price.replace("$", ""));
...
//# sourceMappingURL=_0225396d._.js.map