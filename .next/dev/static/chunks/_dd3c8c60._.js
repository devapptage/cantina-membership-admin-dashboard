...
class ApiClient {
    ...
    constructor(baseURL){
        ...
        this.baseURL = baseURL || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || 'http://localhost:3000/api';
    }
    getToken() {
    ...
    async handleResponse(response) {
        ...
        if (!response.ok) {
            const errorMessage = isJson && data?.message || isJson && data?.error || data || `HTTP error! status: ${response.status}`;
            return {
                success: false,
                error: errorMessage,
...
//# sourceMappingURL=_dd3c8c60._.js.map